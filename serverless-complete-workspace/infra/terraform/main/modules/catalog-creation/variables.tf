...
# =============================================================================
# Creates S3 bucket, KMS key, IAM role, storage credential, external location,
# catalog, optional default namespace, and optional medallion schemas (bronze/silver/gold).
# Workspace must already have a metastore assigned.
# =============================================================================
