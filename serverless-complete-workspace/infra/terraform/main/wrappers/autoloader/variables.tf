...
variable "source_s3_path" {
  description = "S3 path for autoloader source data"
  type        = string
}
...
variable "configure_s3_notification" {
  description = "Whether to configure S3 bucket notification"
  type        = bool
  default     = true
}
...
variable "pipeline_channel" {
  description = "DLT pipeline channel"
  type        = string
  default     = "CURRENT"
}

variable "pipeline_edition" {
  description = "DLT pipeline edition"
  type        = string
  default     = "ADVANCED"
}
