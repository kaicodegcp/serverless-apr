...
variable "workspace_id" {
  description = "Workspace ID to assign the service principal to. Set to null to skip workspace assignment."
  type        = string
  default     = null
}

variable "workspace_permissions" {
  description = "Workspace permissions for the SP (e.g. USER, ADMIN)"
  type        = list(string)
  default     = ["USER"]
}

variable "application_id" {
  description = "UUID/application ID of the service principal."
  type        = string
  default     = null
}
