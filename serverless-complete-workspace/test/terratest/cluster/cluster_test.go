...
func getTerraformDir(t *testing.T) string {
	...
	return filepath.Clean(filepath.Join(cwd, "..", "..", "..", "infra", "terraform", "main", "wrappers", "cluster"))
}

func getVarFile(t *testing.T) string {
	tfDir := getTerraformDir(t)
	return filepath.Join(tfDir, "aws-SE-99d097-databricks", "us-east-1", "terraform-cluster.auto.tfvars")
}

func TestCluster_InitValidate(t *testing.T) {
	...
	t.Log("Init + Validate passed for cluster")
}

func TestCluster_Plan(t *testing.T) {
	terraformDir := getTerraformDir(t)
	varFile := getVarFile(t)
	...
	t.Log("Plan passed for cluster")
}

func TestCluster_ApplyDestroy(t *testing.T) {
	terraformDir := getTerraformDir(t)
	varFile := getVarFile(t)
...
func TestCluster_VariableValidation(t *testing.T) {
	terraformDir := getTerraformDir(t)
	varFile := getVarFile(t)
	...
	t.Log("Variable validation passed for cluster")
}

func TestCluster_InputAssertions(t *testing.T) {
	terraformDir := getTerraformDir(t)
	...
	assert.NotNil(t, opts.Vars["cluster_name"], "cluster_name should be set")
	assert.NotNil(t, opts.Vars["spark_version"], "spark_version should be set")

	t.Log("Input assertions passed for cluster")
}
