...
func getTerraformDir(t *testing.T) string {
	...
	return filepath.Clean(filepath.Join(cwd, "..", "..", "..", "infra", "terraform", "main", "wrappers", "job"))
}

func getVarFile(t *testing.T) string {
	tfDir := getTerraformDir(t)
	return filepath.Join(tfDir, "aws-SE-99d097-databricks", "us-east-1", "terraform-job.auto.tfvars")
}

func TestJob_InitValidate(t *testing.T) {
	...
	t.Log("Init + Validate passed for job")
}
...
func TestJob_Plan(t *testing.T) {
	...
	t.Log("Plan passed for job")
}

func TestJob_ApplyDestroy(t *testing.T) {
	terraformDir := getTerraformDir(t)
	varFile := getVarFile(t)
...
func TestJob_VariableValidation(t *testing.T) {
	terraformDir := getTerraformDir(t)
	varFile := getVarFile(t)
	...
	t.Log("Variable validation passed for job")
}

func TestJob_InputAssertions(t *testing.T) {
	terraformDir := getTerraformDir(t)
	...
	t.Log("Input assertions passed for job")
}
